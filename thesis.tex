...
\newcommand{\thesisacro}[3]{\newacro{#1}[#2]{#3}}
\input{frontbackmatter/AcronymEntries}
\input{frontbackmatter/AcronymAliases}
...
%\include{chapters/einfuehrung/chapter01}
\include{chapters/grundlagen/chapter02}
\include{chapters/methodik/chapter03}
\include{chapters/ergebnisse/chapter04}
\include{chapters/zusammenfassung/chapter05}
\include{chapters/Ausblick/chapter06}
...
\cleardoublepage
  \part{Appendix}
\include{chapters/Anhang/chapter07}
