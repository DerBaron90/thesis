...
\begin{otherlanguage}{ngerman}
	...
	\begin{center}
        ...
        \end{center}
	Die strikt synchrone Verarbeitung von Objekten in einem Incident-Response-Scanner kann zu längeren Verarbeitungszeiten und RAMSpitzen führen.
	Sowohl bei regelmäßigen Scans als auch in Incident Response Szenarien ist eine kurze Laufzeit, eine 
