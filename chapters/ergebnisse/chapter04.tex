...
Auch das Verhalten der RAM-Auslastung, 
...
Der SSTF-Scheduler wird mit dem FIFO-Scheduler verglichen, um die Auswirkungen des Priorisierungsansatzes auf die Performance zu bewerten.
...
Außerdem ist die Execution Time bei SSTF im 1-Thread-Fall klar niedriger als bei beiden FIFO-Varianten.
\textcolor{red}{Hier Erklärung für, warum das so ist.}
...
Zusammen genommen sind das klare Verbesserungen gegenüber FIFO.
...
Der Work-Stealing mit SSTF-Priorisierung Scheduler wird primär mit dem SSTF-Scheduler verglichen, 
...
\paragraph{Stabilität}
Die Stabilität entspricht weitgehend dem Bild bei FIFO und SSTF.
Bei einem Thread bleibt die CPU-Auslastung über die Testläufe hinweg konstant,
...
wenn möglich mit möglichst geringer Ressourcen-Auslastung.
Ein responsiver Scanner, also niedriger Wartezeit von Tasks, 
ist ebenfalls wünschenswert, aber nicht auf Kosten einer höheren Laufzeit.
...
Work-Stealing senkt den Anteil synchroner Tasks weiter auf 35.31\% und erreicht zugleich die beste Laufzeit auf Windows,
...
\noindent Die Auswertung zeigt, dass SSTF im Bezug auf die gewählten Prioritäten die beste Gesamtbalance aus Laufzeit, 
Stabilität und Ressourceneffizienz bietet und wird damit als bevorzugte Scheduler-Strategie empfohlen.
